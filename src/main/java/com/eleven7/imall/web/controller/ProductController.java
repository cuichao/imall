...
public class ProductController implements ServletContextAware {
	...
	public ModelAndView showProduct(@PathVariable("productId") Integer productId) {
		Product p = this.productService.getProduct(productId);
		List<ProductDetail> pdList = this.productService.getProudctDetailList(p
				.getId());
		List<ProductComment> pcList = this.productService.getCommentList(p
				.getId());
